...
@section('page-title', __('dash-list-tag.show-tag-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('dash-list-tags.show-tag-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('dash-list-tags.show-tag-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ $tag->codename}}</h5>
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description_fr" class="form-control" id="description_fr" cols="30"
                                          rows="3" readonly>{{$tag->getTranslation('description', 'fr')}}</textarea>
                            </div>
