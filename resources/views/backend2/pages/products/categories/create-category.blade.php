...
@section('page-title', __('categories.create-category-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('categories.create-category-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('categories.create-category-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('categories.create-category-title')</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST"
                              action="{{ route('categories.store', app()->getLocale())  }}">
