...
@section('content')
    ...
    <div class="pagetitle">
        <h1>@lang('Ajouter une Video Publicitaires')</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a
                        href="{{ route('dashboard', app()->getLocale()) }}">@lang('Tableau de Bord')</a></li>
                <li class="breadcrumb-item active">@lang('Ajouter une Video')</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('Ajouter une Video')</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST" action="{{ route('advideos.store', app()->getLocale())  }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="company_id" aria-label="Default select example">
                                    ...
                                    @foreach ($enterprises as $enterprise)
                                        <option value="{{$enterprise->id}}">{{$enterprise->raison_social }}</option>
                                    @endforeach
                                </select>
                            </div>
