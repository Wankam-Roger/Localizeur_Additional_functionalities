...
@section('page-title', __('bcategories.edit-bcategory-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('bcategories.edit-bcategory-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('bcategories.edit-bcategory-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ $bcategory->codename }}</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST"
                              action="{{ route('bcategories.update', [app()->getLocale(), $bcategory->id])  }}">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description_fr" class="form-control" id="description_fr" cols="30"
                                          rows="3">{{$bcategory->getTranslation('description', 'fr')}}</textarea>
                            </div>
