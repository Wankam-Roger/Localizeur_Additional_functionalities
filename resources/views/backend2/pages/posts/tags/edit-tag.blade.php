...
@section('page-title', __('btags.edit-btag-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('btags.edit-btag-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('btags.edit-btag-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('btags.edit-btag-title')</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST"
                              action="{{ route('btags.update', [app()->getLocale(), $btag->id])  }}">
