    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ $btag->codename}}</h5>
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description_fr" class="form-control" id="description_fr" cols="30"
                                          rows="3" readonly>{{$btag->getTranslation('description', 'fr')}}</textarea>
                            </div>
                            <div class="col-md-12">
