                        ...
                        <form class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="quantity_in_stock"
                                       id="quantity_in_stock" value="{{ $product->price }}" readonly>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="short_description_en" class="form-control" id="short_description_en"
                                          cols="30" rows="3"
                                          readonly>{{$product->getTranslation('short_description', 'en')}}</textarea>
                            </div>
                            <div class="col-12">
                                ...
                                <textarea name="short_description_fr" class="form-control" id="short_description_fr"
                                          cols="30" rows="3"
                                          readonly>{{$product->getTranslation('short_description', 'fr')}}</textarea>
                            </div>

                            <div class="col-12">
                                <label for="description_en" class="form-label">Description En</label>
                                <textarea name="description_en" class="tinymce-editor" id="description_en"
                                          readonly>{{$product->getTranslation('description', 'en')}}</textarea>
                            </div>
                            <div class="col-12">
                                ...
                                <textarea name="description_fr" class="tinymce-editor" class="form-control"
                                          id="description_fr"
                                          readonly>{{$product->getTranslation('description', 'fr')}}</textarea>
                            </div>
