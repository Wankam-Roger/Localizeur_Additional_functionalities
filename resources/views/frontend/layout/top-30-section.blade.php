    ...
    <div class="container">
        ...
        <div class="fl-wrap">
                ...
                <article class="geodir-category-listing fl-wrap">
                    ...
                    <div class="geodir-category-content fl-wrap title-sin_item">
                        ...
                        <div class="geodir-category-text fl-wrap">
                            <p class="small-text"> @lang('Our carefully curated list features the finest dining establishments that offer an extraordinary gastronomic experience.')</p>

                        </div>
                        <div class="geodir-category-footer fl-wrap">
                            <a class="listing-item-category-wrap">
                                <div class="listing-item-category red-bg"><i class="fal fa-cheeseburger"></i></div>
                                <span>@lang('Restaurants')</span>
                            </a>
            ...
            @foreach($entreprises as $entreprise)
                @if($entreprise->top_30)
                    <!-- listing-item  -->
                        <div class="listing-item" style="margin-bottom: 40px">
                            <article class="geodir-category-listing fl-wrap">
                                <div class="geodir-category-img">

                                    <a href="{{ route('single-company',[app()->getLocale(), $entreprise->id]) }}" class="geodir-category-img-wrap fl-wrap">
                                    ...
                                    @if($entreprise->logo !== null)
                                        <div class="listing-avatar"><a href="author-single.html"><img src="{{ asset($entreprise->logo)}}" alt=""></a>
                                ...
                                <div class="geodir-category-content fl-wrap title-sin_item">
                                    <div class="geodir-category-content-title fl-wrap" style="height: 60px;">
                                        <div class="geodir-category-content-title-item">
                                            <h3 class="title-sin_map"><a href="listing-single.html">{{$entreprise->raison_social}}</a><span class="verified-badge"><i class="fal fa-check"></i></span></h3>
                                    ...
                                    <div class="geodir-category-footer fl-wrap">
                                        ...
                                        <div class="geodir-category_contacts">
                                            <div class="close_gcc"><i class="fal fa-times-circle"></i></div>
                                            <ul class="no-list-style">
                                                <li><span><i class="fal fa-phone"></i> @lang('Call :') </span><a href="#">{{$entreprise->localisation_tel}}</a></li>
                                                <li><span><i class="fal fa-envelope"></i> @lang('Write : ')</span><a href="#">yourmail@domain.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
