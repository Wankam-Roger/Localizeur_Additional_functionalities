...
<section class="parallax-section single-par" data-scrollax-parent="true">
    <div class="bg par-elem " data-bg="{{ asset('frontend/images/bg/localizeur-hero-slide/2.jpeg') }}"
         data-scrollax="properties: { translateY: '30%' }"></div>
    <div class="overlay op7"></div>
    <div class="container">
        <div class="section-title center-align big-title">
            <h2><span>{{ $town->titre  }}</span></h2>
            <span class="section-separator"></span>
            <div class="breadcrumbs fl-wrap"><a
                    href="{{route('index', app()->getLocale())}}">{{ __('menu-home') }}</a><span>{{ __('menu-secteur-activite')}}</span>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="list-main-wrap-header fl-wrap   block_box no-vis-shadow no-bg-header fixed-listing-header">
            ...
            <div class="list-main-wrap-title">
                <h2>@lang(Results For : )<span>{{ $town->titre  }} </span></h2>
            </div>
