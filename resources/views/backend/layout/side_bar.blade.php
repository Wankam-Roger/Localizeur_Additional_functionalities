        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
               ...
               <!--  <li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="bx bx-home-circle"></i><span class="badge rounded-pill bg-info float-end">08</span>
                        <span key="t-dashboards">Entreprises</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('show-all-enterprises', app()->getLocale())}}" key="t-default">Liste d'entreprises</a></li>
                        <li><a href="{{route('create-enterprise', app()->getLocale())}}" key="t-crypto">Ajouter une entreprise</a></li>

                        <li><a href="{{route('show-all-criteres', app()->getLocale())}}" key="t-default">Critere</a></li>
                        <li><a href="{{route('create-critere', app()->getLocale())}}" key="t-crypto">Ajouter un Critere</a></li>

                        <li><a href="{{route('show-all-documents', app()->getLocale())}}" key="t-default">Documents</a></li>
                        <li><a href="{{route('create-document', app()->getLocale())}}" key="t-crypto">Ajouter un
                                Documents</a></li>

                        <li><a href="{{route('show-all-secteurs', app()->getLocale())}}" key="t-default">Secteurs
                                D'activités</a></li>
                        <li><a href="{{route('create-secteur', app()->getLocale())}}" key="t-crypto">Ajouter un Secteur
                                D'activité</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="bx bx-world"></i><span class="badge rounded-pill bg-info float-end">04</span>
                        <span key="t-dashboards">Localizations</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">


                        <li><a href="{{route('show-all-countries', app()->getLocale())}}" key="t-countries">Pays</a>
                        </li>
                        <li><a href="{{route('create-country', app()->getLocale())}}" key="t-add-country">Ajouter un
                                Pays</a>
                        </li>

                        <li><a href="{{route('show-all-streets', app()->getLocale())}}" key="t-streets">Quartier</a>
                        </li>
                        <li><a href="{{route('create-street', app()->getLocale())}}" key="t-add-street">Ajouter un
                                Quartier</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="bx bx-message"></i><span class="badge rounded-pill bg-info float-end">03</span>
                        <span key="t-dashboards">Commentaires</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">

                        <li><a href="{{route('show-all-comments', app()->getLocale())}}"
                               key="t-comments">Commentaire</a>
                        </li>
                        <li><a href="{{route('create-comment', app()->getLocale())}}" key="t-add-comment">Ajouter un
                                Commentaire</a></li>

                        <li><a href="{{route('admin_show_subscriber_mails_page', app()->getLocale())}}"
                               key="t-subscribers">Souscripteurs</a>
                        </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="bx bx-book"></i><span class="badge rounded-pill bg-info float-end">04</span>
                        <span key="t-dashboards">Livres</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('admin_show_books_page', app()->getLocale())}}" key="t-book">Liste des
                                Livres</a></li>
                        <li><a href="{{route('admin_create_book_page', app()->getLocale())}}" key="t-add-book">Ajouter
                                un
                                Livre</a></li>

                        <li><a href="{{route('admin_show_book_tags_page', app()->getLocale())}}" key="t-book-tag">Liste
                                des Tags</a></li>
                        <li><a href="{{route('admin_create_book_tag_page', app()->getLocale())}}" key="t-add-book-tag">Ajouter
                                un Tag</a></li>

                        <li><a href="{{route('admin_show_book_categories_page', app()->getLocale())}}"
                               key="t-book-category">Liste
                                des Categories</a></li>
                        <li><a href="{{route('admin_create_book_category_page', app()->getLocale())}}"
                               key="t-add-book-category">Ajouter
                                un Categorie</a></li>

                        <li><a href="{{route('admin_show_book_subscribers_page', app()->getLocale())}}"
                               key="t-book-category">Liste
                                des Souscripteurs</a></li>
                        <li><a href="{{route('admin_create_book_subscriber_page', app()->getLocale())}}"
                               key="t-add-book-category">Ajouter
                                un Souscripteur</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="bx bx-home-circle"></i><span class="badge rounded-pill bg-info float-end">03</span>
                        <span key="t-profiles">Profiles</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">

                        <li><a href="{{ route('admin_show_journals_page',[app()->getLocale()]) }}" key="t-default">Profiles</a></li>
                        <li><a href="{{ route('admin_show_categories_page',[app()->getLocale()]) }}" key="t-crypto">Categories</a></li>

                        <li><a href="{{ route('admin_show_tags_page',[app()->getLocale()]) }}" key="t-default">Tags</a></li>
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarBlog" data-bs-toggle="collapse" role="button"
                       aria-expanded="false" aria-controls="sidebarPages">
                        <i class="ri-pages-line"></i> <span data-key="t-pages">Blog | Journal</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarBlog">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('admin_show_journals_page',[app()->getLocale()]) }}" class="nav-link"
                                   data-key="t-starter"> Profiles </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin_show_categories_page',[app()->getLocale()]) }}"
                                   class="nav-link" data-key="t-starter"> Categories </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin_show_tags_page',[app()->getLocale()]) }}" class="nav-link"
                                   data-key="t-starter"> Tags </a>
                            </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="bx bx-sitemap"></i><span class="badge rounded-pill bg-success float-end">01</span>
                        <span key="t-dashboards">Gestion du site</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">

                        <li>
                            <a href="javascript: void(0);" class="has-arrow" key="t-level-1-2">Slider</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('show-all-hero-slides', app()->getLocale())}}" key="t-crypto">Slides</a></li>
                                <li><a href="{{route('create-hero-slide', app()->getLocale())}}" key="t-crypto">Ajouter un SLide</a></li>
