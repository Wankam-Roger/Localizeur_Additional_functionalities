    ...
    <div class="card border card-border-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="">
                        <form method="post" action="{{ route('admin_store_tag_page',[app()->getLocale()]) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-4">
                                <label for="short_description_fr">Description du Tag <span style="color: red"></span></label>
