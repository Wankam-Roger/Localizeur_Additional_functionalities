                        ...
                        <div id="categoryList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a type="button"
                                           href="{{ route('admin_create_book_category_page',[app()->getLocale()]) }}"
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-success edit-item-btn"
                                                                ...
                                                                data-bs-category-name="{{ $category->name_fr }}">
                                                            Modifier
                                                        </button>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn"
                                                                ...
                                                                data-bs-category-id="{{ $category->id }}">Supprimer
                                                        </button>
                                                    </div>
                                                </div>
                                            </td>
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('admin_update_book_category_page',[app()->getLocale()]) }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="{{ route('admin_delete_book_category_page',[app()->getLocale()]) }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3" id="modal-id" style="display: none;">
                            <label for="id-field" class="form-label">ID</label>
    ...
    <script type="text/javascript">
        ...
        editCategoryModal.addEventListener("show.bs.modal", function (t) {
            var id = t.relatedTarget.getAttribute("data-bs-category-id"),
                name = t.relatedTarget.getAttribute("data-bs-category-name");
