            ...
            <div class="col-xl-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin_update_book_page', app()->getLocale()) }}"
                            ...
                            <div class="form-group mb-4">
                                <label for="formFile" class="form-label">Image 01
                                </label>
                                <input class="form-control" type="file" id="formFile" name="image_path">
                            </div>

                            <div class="form-group mb-4">
                                <label for="formFile" class="form-label">Image 02
                                </label>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" placeholder="Titre" id="title_fr" class="form-control"
                                       name="title_fr" value="{{ $book->title_fr }}">
                            </div>

                            <div class="form-group mb-4">
                                <label for="title_fr">Auteur <span style="color: red">*</span></label>
                                <input type="text" placeholder="Auteur" value="{{ $book->author }}" id="author"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="ckeditor form-control"
                                          name="description_fr">{{ $book->description_fr }}</textarea>
                            </div>

                            <div class="form-group mb-4">
                                <label for="title_fr">Temps de lecture <span style="color: red">*</span></label>
                                <input type="number" placeholder="Temps de lecture" value="{{ $book->post_read_time }}"
                                       id="post_read_time"
